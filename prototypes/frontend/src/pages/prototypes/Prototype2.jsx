...
function Prototype2({ setCurrentPage, submissionId, submissionDetails, markPrototypeComplete }) {
  ...
  const instructions = "Focus on distinctive features and textures. Get as close as possible while maintaining sharp focus. Document unique characteristics.";
